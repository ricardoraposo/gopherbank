...
func (tq *TransactionQuery) QueryFromAccount() *AccountQuery {
...
func (tq *TransactionQuery) QueryToAccount() *AccountQuery {
	query := (&AccountClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (tq *TransactionQuery) Clone() *TransactionQuery {
	...
	return &TransactionQuery{
		...
		withFromAccount: tq.withFromAccount.Clone(),
		withToAccount:   tq.withToAccount.Clone(),
...
func (tq *TransactionQuery) WithFromAccount(opts ...func(*AccountQuery)) *TransactionQuery {
	query := (&AccountClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withFromAccount = query
	return tq
}
...
func (tq *TransactionQuery) WithToAccount(opts ...func(*AccountQuery)) *TransactionQuery {
	query := (&AccountClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withToAccount = query
	return tq
}
...
func (tq *TransactionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Transaction, error) {
	...
	if query := tq.withFromAccount; query != nil {
		if err := tq.loadFromAccount(ctx, query, nodes, nil,
			func(n *Transaction, e *Account) { n.Edges.FromAccount = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withToAccount; query != nil {
		if err := tq.loadToAccount(ctx, query, nodes, nil,
			func(n *Transaction, e *Account) { n.Edges.ToAccount = e }); err != nil {
			return nil, err
		}
	}
...
func (tq *TransactionQuery) loadFromAccount(ctx context.Context, query *AccountQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *Account)) error {
...
func (tq *TransactionQuery) loadToAccount(ctx context.Context, query *AccountQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *Account)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Transaction)
	for i := range nodes {
